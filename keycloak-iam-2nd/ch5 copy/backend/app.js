...
//keycloak.protect('realm:myrole')
//keycloak.protect('oauth-playground:client_role')
//keycloak.protect('myrole_scope')
...
app.listen(53000, function () {
  console.log('Started at port 53000');
});
